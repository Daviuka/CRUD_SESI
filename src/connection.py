...
class Config:
    ...
    DB_USER = os.getenv('DB_USER').strip()  # Nome do usuário do banco
    DB_PASS = os.getenv('DB_PASS').strip()  # Senha do banco
    DB_HOST = os.getenv('DB_HOST').strip()  # Host do banco
    DB_NAME = os.getenv('DB_NAME').strip()  # Nome do banco
    DB_PORT = os.getenv('DB_PORT').strip()  # Porta do banco
